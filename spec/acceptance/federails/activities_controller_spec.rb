...
RSpec.describe Federails::ActivitiesController, type: :acceptance do
    ...
    let(:inbox_payload) do
      {
        ...
        'id'       => federails.actor_activity_url(actor, following.activities.last),
        'type'     => 'Create',
        'actor'    => distant_actor.federated_url,
        'object'   => federails.actor_following_url(actor, following),
